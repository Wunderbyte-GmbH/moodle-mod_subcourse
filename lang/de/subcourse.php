...
$string['nocoursesavailable'] = 'Keine Kurse von denen Du Noten holen könntest.';
$string['nosubcourses'] = 'Es gibt keine Unterkurse in diesem Kurs.';
$string['pluginadministration'] = 'Subcourse Administration';
$string['pluginname'] = 'Subcourse';
$string['privacy:metadata'] = 'Das Subkurs Modul speichert keine persönlichen Daten.';
$string['refcourse'] = 'Referenzierter Kurs ';
...
$string['refcoursecurrent'] = 'Behalte die aktuellen Referenzen';
$string['refcourselabel'] = 'Hole Noten von';
$string['refcoursenull'] = 'Kein referenzierter Kurs eingestellt';
$string['subcourse:addinstance'] = 'Füge einen neuen Subkurs hinzu';
$string['subcourse:begraded'] = 'Erhalte Note vom referenzierten Kurs.';
$string['subcourse:fetchgrades'] = 'Hole die Noten manuell vom referenzierten Kurs.';
$string['subcourse:view'] = 'Zeige Subkurs Aktivität';
$string['subcoursename'] = 'Name des Subkurses.';
$string['taskcheckcompletedrefcourses'] = 'Überprüfe Abschlussstatus des referenzierten Kurses.';
$string['taskfetchgrades'] = 'Hole die Noten des Subkurses.';
$string['completioncourse'] = 'Verlange abgeschlossenen Kurs.';
$string['completioncourse_help'] = 'Wenn angekreuzt wird die Aktivität als abgeschlossen markiert, wenn der referenzierte Kurs abgeschlossen ist.';
